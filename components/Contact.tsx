        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center space-y-10">
            <div>
              ...
              <p className="reveal reveal-delay-2 font-sans text-muted leading-relaxed mt-6 text-base">
                İlk deneme dersi veya genel bilgi için WhatsApp üzerinden bize
                ulaşın. Size en uygun ders programını birlikte planlayalım.
              </p>
            </div>
            ...
            <div className="reveal reveal-delay-2">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-sans text-[10px] tracking-[0.2em] uppercase text-muted mb-0.5">
                    Adres
                  </div>
